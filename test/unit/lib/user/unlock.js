...
const fin = justo.fin;
const op = require("../../../../dist/es5/nodejs/justo-plugin-linuxuser/lib/user/unlock").default;
...
suite("#op()", function() {
  ...
  init({name: "*", title: "Create test user"}, function() {
    child_process.spawnSync("adduser", [USERNAME]);
    child_process.spawnSync("usermod", ["--lock", USERNAME]);
